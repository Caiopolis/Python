...
#print('| ' * 7)
#print('Ótimo, temos então a taboada de {} \nMas, que tal fazer alguns calculos de multiplicação para treinar!!'.format(tabuada))
#per = str(input('Deseja realizar os calculos? '))
#if per != 'Não' and per != 'não':
#    print('Otimo, vamos lá...')
#    x1 = float(input('Digite o numerador: '))
#    x2 = float(input('Digite o seu multiplicador: '))
#    print('{} x {} = {}'.format(x1, x2, x1 * x2))
#    per2 = str(input('Deseja fazer mais multiplicação? '))
